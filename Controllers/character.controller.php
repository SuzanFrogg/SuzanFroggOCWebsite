    ...
    public function __construct()
    {
        $this->arrayCharacters = array();
				...
				*/
				...
				$akio = new Character("Shido_Akio","Shido","Akio",14,153,"Male","05/04","None",
				...
				$aly = new Character("Spine_Aly","Spine",
		 		"Aly",128,168,"Male","03/01","God","Being powerful, wayching moovies and the night.",
				"Have to wake up.",
				...
				$ama = new Character("Hona_Ama","Hona",
		 		"Ama",29,162,"Female","20/02","Beaver","Her son, work and read, water.",
				"Driving and the salt.",
				array("Hona_Dahi" => "Cousin", "Hona_Yth" => "Son", "Hona_Aynth" => "Wife",
				...
				$sera = new Character("Shido_Sera","Shido","Sera",14,150,"Female","05/04","None",
				...
				$amset = new Character("_Amset","",
		 		"Amset",21,176,"Male","06/06","None","Gardening, Laly , smoking, plants.",
				"Bugs, snow.",
				...
				$ash = new Character("_Ash","",
		 		"Ash",119,162,"Female","17/05","Zombie","Naly , bodybuilding, kindly scare people.",
				...
				$aynth = new Character("Hona_Aynth","Hona",
		 		"Aynth",25,173,"Female","21/09","Centaur","The night, the forest and run.",
				"Ice cream and the city.",
				array("Hona_Ama" => "Wife", "Hona_Yth" => "Stepson",
				...
				$dahi = new Character("Hona_Dahi","Hona",
		 		"Dahi",21,178,"Female (Trans)","05/12","Fox","Meat, see the sunset, cutes clothes",
				...
				$domma = new Character("Ewana_Domma","Ewana",
		 		"Domma",38,181,"Male","25/12","None","The respect of the autority, god, his wife Lyci and his daughter Tori.",
				...
				$heiby = new Character("Merry_Heiby","Merry",
		 		"Heiby",17,165,"Genderfluid","21/12","Lamia","Raw frogs, confuse people about they gender and green.",
				"Their boobs, the pepper",
				array("_Sally" => "Crush", "Merry_Smo" => "Adoptive Brother",
				...
				$jack = new Character("_Jack","",
		 		"Jack",23,181,"Male","30/11","None","Chocolate, Satoru",
				...
				$jun = new Character("_Jun","",
		 		"Jun",22,185,"Male","11/11","None","Saki, drink.",
				"The life, himself.",
				...
				$kaele = new Character("Letha_Kaële","Letha",
		 		"Kaële",769,181,"Female","26/07","Goddess","Rain, plants, forest, her sister Khöös and animals.",
				"Storm, humans.",
				...
				$koos = new Character("Letha_Köös","Letha",
		 		"Köös",4296,275,"Female","Unknow","Goddess","Humans, play chest, rain, fishs and love.",
				"Sadness, wickedness.",
				...
				$laly = new Character("_Laly","",
		 		"Laly",24,166,"Female","15/08","Tulip","Nature, water, sun and Amset.",
				"Insects, wickedness.",
				...
				$lelyte = new Character("_Lèlytè","",
		 		"Lèlytè",23,169,"Female","21/09","Buterfly",
				...
				$lyci = new Character("Ewana_Lyci","Ewana",
		 		"Lyci",36,163,"Female","18/04","None","To sew, do charity work, god, her husband Domma and her daughter Tori.",
				...
				$lysthill = new Character("Hona_Lysthill","Hona",
		 		"Lysthill",4,79,"Female","02/09","Bird","Play with her old brother, fly, eat.",
				"Beans, school.",
				...
				$mary = new Character("Lewis_Mary","Lewis",
		 		"Mary",21,163,"Female","22/03","None","The \"haute couture\", spaghetti.",
				"Commoners.",
				...
				$miranda = new Character("Merry_Miranda","Merry",
		 		"Miranda",23,163,"Female","09/02","Spider","The night, read , draw and animals.",
				"To sew and cartoons.",
				...
				$naly = new Character("_Naly","",
		 		"Naly",19,167,"Female","02/02","None"," Ash , dance, sing , mediation and gold.",
				"Noise , children.",
				...
				$nyaomie = new Character("Dass_Nyaomie","Dass",
		 		"Nyaomie",17,161,"Female","23/02","Cat","Tomoyo, listen to the rain falling, see the snow falling, fishs.",
				...
				$oseli = new Character("Spine_Oseli","Spine",
		 		"Oseli",132,174,"Female","09/08","Goddess","Crystals, peace, colors.",
				"Noise, use her power",
				...
				$phia = new Character("Shido_Phia","Shido",
		 		"Phia",28,167,"Female","09/03","None","Her children , read and being out of her house.",
				...
				$rinji = new Character("_Rinji","",
		 		"Rinji",17,174,"Male","20/08","Earth nymph","ead, Stay in the forest for hours.",
				...
				$rira = new Character("Nina_Rira","Nina",
		 		"Rira",22,176,"Female","12/11","Half Cyborg","o fight, the technology, the drugs.",
				...
				$rocre = new Character("Shido_Rocre","Shido",
		 		"Rocre",41,179,"Male","10/10","None","Drink and have sex.",
				...
				$ruby = new Character("Lewis_Ruby","Lewis",
		 		"Ruby",16,171,"Female","28/12","None","Be the center of the attention, make fun of people, makeup and jewel.",
				...
				$ruth = new Character("_Ruth","",
		 		"Ruth",22,171,"Female","15/01","None","Time travelling, the XX century, read.",
				...
				$saki = new Character("Nina_Saki","Nina",
		 		"Saki",19,170,"Female","29/03","Dragon","Her moto, her guns, to fight.",
				...
				$sally = new Character("_Sally","",
		 		"Sally",18,162,"Female","14/03","None","Yaoi, mangas, cats, eat, fun t-shirt.",
				...
				$satoru = new Character("Hona_Satoru","Hona",
		 		"Satoru",22,178,"Male","02/05","Snake","Crawl, meat.",
				"Flowers and birds.",
				...
				$sha = new Character("_Sha","",
		 		"Sha",16,165,"Female","20/10","None","Sleep, be barefoot, talk with peoples.",
				...
				$shao = new Character("_Shao","",
		 		"Shao",1225,352,"Female","30/10","Goddess","Play, children, her sis",
				...
				$asoh = new Character("_Asoh","",
		 		"Asoh",1225,353,"Female","30/10","Goddess","Think, watchs humans, her sister.",
				...
				$smo = new Character("Merry_Smo","Merry",
		 		"Smo",19,171,"Male","01/09","Mermaid","Shells and Sleeping.",
				"Sharks and Seafood.",
				...
				$tomoyo = new Character("Ewana_Tomoyo","Ewana",
		 		"Tomoyo",16,159,"Female","13/07","None","To balance, her girlfriend Nyaomie.",
				...
				$tori = new Character("Ewana_Tori","Ewana",
		 		"Tori",16,159,"Female","13/07","none","Her family even if she's not really close of them, read, see her friend, god.",
				...
				$tsyna = new Character("Dass_Tsyna","Dass",
		 		"Tsyna",22,163,"Female","25/06","Rabbit","Vegetables, run, help her friend and smokes even if she know it's a bad habit.",
				...
				$yth = new Character("Hona_Yth","Hona",
		 		"Yth",5,85,"Male","30/06","Deer","Play fight video games, listen music and spend time with his uncle.",
        ...
        array_push($this->arrayCharacters, $kaele);
				...
				//AUTRE MONDE
				$alice = new CharacterAM("_Alice","",
				"Alice",17,0,"Female","15/06","Otaku","Defined by player",
				"Defined by player",array("_Yume" => "Potential girlfriend"),
				...
				array("https://cloud.refsheet.net/images/images/000/121/621/large/Alice_ref_-g.png?1532115662", "https://cloud.refsheet.net/images/images/000/121/625/large/alice.png?1532115730","https://cloud.refsheet.net/images/images/000/121/626/large/alice_%282%29.png?1532115731"),"https://cloud.refsheet.net/images/images/000/121/627/medium/alice_pic.PNG?1532115776",
				"Righthanded","Defined by player","Replique","None","None","None","None",true);


				$izumo = new CharacterAM("_Izumo","",
		 		"Izumo",10 ,0 ,"Female","18/01","Android","Her stuffed animals, lying.",
				"The heat",array("_Vea" => "Adoptive Sister"),
				...
				"Righthanded","","Guns","Mithril's Tange","Leather bandana","Leather clothings","None",true);

				$nwet = new CharacterAM("_Nwet","",
		 		"Nwet",21,0,"Male","25/08","Deamon","Fox, travelling",
				"Hypocrisy",
				array(),
				"He came from Aros, he lived in a poor family and fighted a lot, his two scars, one in the face, one on the right arm, came from there.","He is bisexual.",
				...
				"Lefthanded","Self Assured and dynamic","Runic Sword","Shield of the dragon","Helm of the dragon","Elementary cap","Warior amulet",true);

				$shu = new CharacterAM("_Shu","",
		 		"Shu",25,0,"Male","12/07","Unknow","His family, suits, help people.",
				...
				"Unknow","Unknow","Unknow","Unknow","Unknow","Unknow","Unknow",false);

				$tulki = new CharacterAM("_Tülki","",
		 		"Tülki",19,0,"Male","29/04","Fox","Tulips, ice cream.",
				"Snakes.",
				array(),
				"He come from the world Furid, he's a fox, one of the highest class, he never really understood how he was arrived at Kerga .","He is pansexual.",
				...
				"Righthanded","Happy and absentminded","Fox Claws","Dragon's shield","Silver pin","Skill cape","None",true);

				$vea = new CharacterAM("_Vea","",
		 		"Vea",223,0,"Female","24/10","Elf","Her master, fire, use magic.",
				...
				$yume = new CharacterAM("_Yume","",
		 		"Yume",19,0,"Female","29/02","Cat","Fish, sun, to sew.", "Insects.",
				array("_Alice" => "Possible girlfriend"),
				"Came from Furid world, she lived in the Mao Region and liked to sew.
				One day she buy an old Teddy Bear in a flea market and she was teleport to Kerga.","She is omnisexual.",
				...
				"Ambidextrous","Sweet and gentle","Cat claws","None","None","Coton dress","None",true);
        ...
        array_push($this->arrayCharacters, $yume);
				...
				//Undertale
				$leak = new CharacterUndertale("_Leak","",
		 		"Leak",0,0,"Female","17/09","Octopus","Science and noodles.",
				"Carrots and be bored.",
				array("Undyne" => "Friend", "Alphys" => "Friend and colleague",
        ...
        array_push($this->arrayCharacters, $leak);
				...
				//Houseki No Kuni
				$citrine = new CharacterHNK("_Citrine","",
		 		"Citrine",0,172,"Male","31/07","","Love and and helping peoples to find love.",
				"Rain and snakes.",
				array(),
				...
				"https://cloud.refsheet.net/images/images/000/188/965/medium/Citrine_pic.png?1543083338",7);

				$lemonchrysoprase = new CharacterHNK("Chrysoprase_Lemon","Chrysoprase",
		 		"Lemon",0,169,"Male","25/09","","Meditation and Loves' stories.",
				...
				"https://cloud.refsheet.net/images/images/000/188/941/medium/Lemon_Chrysoprase_Pic.png?1543080342",7);
        ...
        array_push($this->arrayCharacters, $lemonchrysoprase);
        	...
        	array_push($newarray, $this->getCharacter($chara));
				...
				//Trier taille /temp /todo /toerase
				/*$arrTaille = array();
				foreach($this->arrayCharacters as $chara)
				{
        	array_push($arrTaille, $chara->getHeight());
				}
				sort($arrTaille);
				$newarray = array();
				foreach($arrTaille as $chara)
				{
        	array_push($newarray, $this->getCharacter($chara));
				}
				$this->arrayCharacters = $newarray;*/
